...
public class RetweetedStatus {
    ...
    private RetweetedStatusEntities entities;
    private RetweetedStatusExtendedEntities extendedEntities;
    ...
    public long[] getDisplayTextRange() { return displayTextRange; }
    @JsonProperty("display_text_range")
    public void setDisplayTextRange(long[] value) { this.displayTextRange = value; }
    ...
    public RetweetedStatusEntities getEntities() { return entities; }
    @JsonProperty("entities")
    public void setEntities(RetweetedStatusEntities value) { this.entities = value; }

    @JsonProperty("extended_entities")
    public RetweetedStatusExtendedEntities getExtendedEntities() { return extendedEntities; }
    @JsonProperty("extended_entities")
    public void setExtendedEntities(RetweetedStatusExtendedEntities value) { this.extendedEntities = value; }
